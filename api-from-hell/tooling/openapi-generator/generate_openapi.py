#!/usr/bin/env python3
"""Generate OpenAPI JSON from the API From Hell catalog."""
...
from fromhelllib import build_openapi, dump_json, load_catalog, print_errors, validate_catalog
...
def main() -> int:
    ...
    output = dump_json(build_openapi(catalog, args.server_url, args.prefix))
    if args.output:
