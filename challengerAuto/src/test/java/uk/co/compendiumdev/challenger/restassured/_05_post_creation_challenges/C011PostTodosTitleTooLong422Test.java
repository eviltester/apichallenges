...
public class C011PostTodosTitleTooLong422Test extends RestAssuredBaseTest {

    @Test
    void can422NotCreateATodoWithTitleTooLong() {
        ...
        Assertions.assertTrue(
                statuses.getChallengeNamed("POST /todos (422) title too long").status);
    }
}
