...
public class PatchTodosPartial200Test extends RestAssuredBaseTest {

    @Test
    void canPatchTodoWithPartialJson() {

        Todo todo = new TodosApi().createTodo("patch partial", "preserve this", false);
        String updatedTitle = "patched partial " + System.currentTimeMillis();
        ...
        statuses.get();
        Assertions.assertTrue(statuses.getChallengeNamed("PATCH /todos/{id} (200) partial").status);
    }
}
