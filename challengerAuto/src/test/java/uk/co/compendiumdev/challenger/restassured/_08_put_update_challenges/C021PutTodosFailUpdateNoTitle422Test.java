...
public class C021PutTodosFailUpdateNoTitle422Test extends RestAssuredBaseTest {
    ...
    void canFailToAmendATodoDueToMissingTitle() {
        ...
        statuses.get();
        Assertions.assertTrue(statuses.getChallengeNamed("PUT /todos/{id} no title (422)").status);
    }
}
