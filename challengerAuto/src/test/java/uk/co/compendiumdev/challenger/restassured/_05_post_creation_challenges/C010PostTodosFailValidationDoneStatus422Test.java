...
public class C010PostTodosFailValidationDoneStatus422Test extends RestAssuredBaseTest {

    @Test
    void can422NotCreateATodoWithInvalidDoneStatusPost() {
        ...
        statuses.get();
        Assertions.assertTrue(statuses.getChallengeNamed("POST /todos (422) doneStatus").status);
    }
}
