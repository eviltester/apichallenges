...
{{<api-live-request method="GET" path="/api/todos" expected-status="200" headers="Accept: application/json" details="true" summary="GET /api/todos with Accept: application/json to request JSON" open="true">}}
