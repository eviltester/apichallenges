...
## DELETE /heartbeat (405) - Not Allowed
...
## PATCH /heartbeat (500) - Internal Server Error
...
## TRACE /heartbeat (501) - Not Implemented
...
### To complete `DELETE /heartbeat (405)` use a DELETE verb
...
{{<api-live-request method="DELETE" path="/heartbeat" expected-status="405" headers="Accept: */*">}}
...
## To complete `PATCH /heartbeat (500)` use a PATCH verb
...
{{<api-live-request method="PATCH" path="/heartbeat" expected-status="500" headers="Accept: */*">}}
...
## To complete `TRACE /heartbeat (501)` use a TRACE verb
...
{{<api-live-request method="TRACE" path="/heartbeat" expected-status="501" headers="Accept: */*">}}
...
## To complete `GET /heartbeat (204)` use a GET verb
...
{{<api-live-request method="GET" path="/heartbeat" expected-status="204" headers="Accept: */*">}}
