...
description: How to solve TRACE /api/heartbeat (501) and trigger Not Implemented.
seo_description: Use this walkthrough to send TRACE /api/heartbeat, verify the 501 response, and see how the API reports an unimplemented heartbeat method for the challenge.
...
schema_howto_steps: Create a TRACE request to /api/heartbeat||Include X-CHALLENGER so progress is tracked||Send the request||Verify the response status is 501
showads: true
---
...
{{<api-live-request method="TRACE" path="/api/heartbeat" expected-status="501" headers="Accept: */*" details="true" challenge-request="true" summary="TRACE /api/heartbeat to trigger 501">}}
