...
For day-to-day exploratory API testing, start with a REST client such as [API Spector](/tools/clients/api-spector) [Bruno](/tools/clients/bruno), [Insomnia](/tools/clients/insomnia), [Postman](/tools/clients/postman), or [cURL](/tools/clients/curl).
