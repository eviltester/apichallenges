...
<section class="online-openapi-ui-client" data-online-openapi-ui-client data-openapi-ui="scalar" data-default-openapi-url="/docs/openapi.json">
...
[Scalar](/reference/open-api-uis/scalar) is an open source API platform with OpenAPI and Swagger support.
